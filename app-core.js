...
function renderSettings(containerId) {
  ...
  html += '<div style=\"font-size:11px;color:var(--text-muted);margin-bottom:8px\">Discards positions recorded when the phone lost satellite lock due to RF interference, metal roofing, or poor signal — these appear as accuracy values of 350m or worse. Must be set higher than the accuracy filter above. Default: 350m.</div>';
